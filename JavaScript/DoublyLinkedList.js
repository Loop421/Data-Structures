...
class DoublyLinkedList
{
  ...
  insert(index, val) {
    /*
      ...
      Set the next and prev properties on the correct node to link everything together
      Increment the length
      return true
    */
  ...
  {
    /*
      *If the index is less than zero or greater than or equal to the lenght return undefined
      *If the index is 0, shift
      *If the index is the same as the length - 1, pop
      *Use the get method to retrieve the item to be remove the found node from the list
